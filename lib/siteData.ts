export const COMPANY_INFO = {
  ...
  address: '1105 Mackey Ave, Chattanooga, TN 37421',
  website: 'https://www.tedfugunt.com',
  hours: {
...
export const CORE_SERVICES = [
  {
    ...
    description: 'Fast AC repair when you need it most. Same-day service available.',
    icon: '❄️',
  },
  {
    id: 'heating-repair',
    title: 'Heating Repair',
    description: 'Emergency heat repair to keep your home warm all winter long.',
    icon: '🔥',
  },
  {
    id: 'installation',
  ...
  },
  {
    ...
    description: 'Upgrade to an efficient new system. Expert recommendations and honest pricing.',
    icon: '🔄',
  },
  {
    id: 'maintenance',
    title: 'Preventive Maintenance',
    description: 'Regular tune-ups to keep your system running smoothly and efficiently.',
    icon: '✓',
  },
  {
    id: 'air-quality',
...
export const TESTIMONIALS = [
  ...
  {
    name: 'Jenny P.',
    quote: 'Reliable, fast service & extremely friendly. They really know their stuff.',
    rating: 5,
  },
  {
    name: 'Michael T.',
...
export const TRUST_SIGNALS = [
  {
    label: 'Carrier Dealer',
    icon: '🏆',
    description: 'Authorized Carrier dealer with premium equipment',
  },
  {
  ...
  {
    label: 'Local Chattanooga Company',
    icon: '📍',
    description: 'Serving our community for years',
  },
  {
    label: 'Financing Available',
    icon: '💳',
    description: 'Flexible payment plans with approved credit',
  },
  {
    label: 'Expert Technicians',
    icon: '👨‍🔧',
    description: 'Licensed HVAC professionals',
  },
  {
...
export const SERVICE_PAGES = [
  ...
  },
  {
    ...
    benefits: [
      ...
      'Experience with all heating systems',
